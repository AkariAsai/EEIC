...
//   //   }
//   // }
//   // return (distance2 < distance1) ? distance1 - distance2 : 1;
// }
...
void simulated_annealing(int n) {
  while (T > 0.00000001) {
    ...
    int c0 = random_integer(n);
    int c1 = random_integer(n);
    double score = distance1 - distance2;
    srand(clock());
...
int main(const int argc, const char **argv) {
  ...
  //   if (shortest > calculate_distance(result, n)) {
  //     memcpy(best_route, result, sizeof(int) * MAX_CITIES);
  //     shortest = calculate_distance(result, n);
  //   }
  // }
  // improve_route(n);
  //
