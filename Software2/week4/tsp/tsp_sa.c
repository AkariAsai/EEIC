//@brief This is Simulated annealing
/*
   Takes more time, but as the number of cities icreases, the total distance get
   shorter than opt-2 & nearest neighbor. The initial route is created randomly.
   n = 3 total distance = 89.790041
   n = 5 total distance = 112.756870
   n = 8 total distance =  141.177041
...
int main(const int argc, const char **argv) {
  ...
  printf("shortest distance %f takes %lld time", calculate_distance(result, n),
         count);
